...
- **使用方法**：
	- 你可以通过本地部署（参考[使用方法](#4-使用方法)），然后用浏览器访问 http://127.0.0.1:5000 使用系统；或者直接网页在浏览器输入 http://8.136.12.26/ ，使用云端部署的系统。
	- 进入系统主页，你会看到如下页面。双击任一个城市即可跳转至该城市子页面。你同样也可以在搜索框查询。![pic1](image/pic3.png)
